        ...
        <div className="mx-auto max-w-4xl px-6 py-16">
          <div className="space-y-12">
            ...
            <div className="rounded-xl border border-orange-600/30 bg-black p-8 shadow-sm">
              ...
              <ul className="mt-4 ml-8 space-y-2 text-white/80">
                <li className="ml-4 flex items-center">
                  <span className="text-2xl ml-8 mr-2">•</span> Service
                  providers who assist with order fulfillment, payment
                  processing, and shipping
                </li>
                <li className="ml-4 flex items-center">
                  <span className="text-2xl ml-8 mr-2">•</span> Legal
                  authorities when required by law
                </li>
                <li className="ml-4 flex items-center">
                  <span className="text-2xl ml-8 mr-2">•</span> Business
